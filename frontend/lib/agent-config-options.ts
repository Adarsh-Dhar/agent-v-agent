...
export const RISK_PROFILE = ['conservative', 'aggressive', 'martingale', 'flat_stake'] as const
...
export const TARGET_SELECTION = ['favorite_only', 'underdog_only', 'first_trigger', 'both'] as const
export const PHASE_WEIGHTING = ['early', 'pre_halftime', 'second_half', 'late_stoppage', 'full_match'] as const
export const REENTRY_RULE = ['no_reentry', 'immediate_reentry', 'capped_reentry'] as const
export const PORTFOLIO_BEHAVIOR = ['independent', 'independent_per_match', 'shared_bankroll', 'correlated_hedging'] as const
...
export type TargetSelection = (typeof TARGET_SELECTION)[number]
export type PhaseWeighting = (typeof PHASE_WEIGHTING)[number]
export type ReentryRule = (typeof REENTRY_RULE)[number]
export type PortfolioBehavior = (typeof PORTFOLIO_BEHAVIOR)[number]
