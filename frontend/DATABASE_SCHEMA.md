...
Copy and paste the entire SQL code below into your Supabase SQL Editor and click **Run**.
...
## If You Only Need to Add Missing Columns

If your `match_players` table already exists but is missing the purse columns, run this instead:

```sql
-- Add purse columns to match_players if they don't exist
ALTER TABLE public.match_players
ADD COLUMN IF NOT EXISTS purse NUMERIC DEFAULT 1000,
ADD COLUMN IF NOT EXISTS initial_purse NUMERIC DEFAULT 1000,
